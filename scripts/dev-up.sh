...
HOST_OPENCODE_STATE_DIR="${HOST_OPENCODE_STATE_DIR:-$PROJECT_DOTDIR/.runtime/opencode-state}"
...
mkdir -p "$HOST_OPENCODE_SHARE_DIR" "$HOST_OPENCODE_STATE_DIR" "$HOST_CACHE_DIR" "$HOST_NPM_CACHE_DIR" "$HOST_PNPM_STORE_DIR" "$HOST_PNPM_HOME_DIR" "$HOST_PIP_CACHE_DIR" "$PROJECT_RUNTIME_DIR/secrets"
...
HOST_OPENCODE_STATE_DIR=$HOST_OPENCODE_STATE_DIR
